...
await message.guild.channels.create('Genel', { type: "category" })  //ottomancode
...
await message.guild.channels.create('Eğlence Kanalları', { type: "category" })    //ottomancode
...
await message.guild.channels.create('Sohbet Kanalları', { type: "category" })  //ottomancode
...
await message.guild.channels.create('Muzik Kanalları', { type: "category" })  //ottomancode
